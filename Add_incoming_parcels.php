...
<body>
		...
		<div class="main">
			...
			<main class="content">
				<div class="container-fluid p-0">
								<h4 class="mb-3 page-head fw-bold">Add Incoming Parcels</h4>
								<form class="form-sample" id="income_form">
										...
										<div class="col-md-12">
											<div class="card">
												<div class="card-body">
													...
													<div class="row base_first_row">
														<div class="form-group col-md-2">
															<label class="col-sm-12 col-form-label fw-bold">IP ID <span class="text-danger">*</span></label>
															<div class="col-sm-12">
																<input type="text" class="form-control grey-textbox" id="ip_id" name="ip_id" readonly required/>
															</div>
														</div>
														...
														<div class="form-group col-md-2">
															<label class="col-sm-12 col-form-label fw-bold">Incoming Type <span class="text-danger">*</span></label>
															<div class="col-sm-12">
																<select class="form-control select2" id="incoming_type" name="incoming_type" required>
																	<option value="">Choose Incoming Type</option>
																	<option value="returnable">Returnable</option>
																	<option value="non_returnable">Non-Returnable</option>
																</select>
															</div>
														</div>
														<div class="form-group col-md-2 dis-none" id="op_id_div">
															<label class="col-sm-12 col-form-label fw-bold">OP ID</label>
															<div class="col-sm-12">
																<select class="form-control select2" id="op_id" name="op_id" data-width="100%">
																	<option value="">Choose OP ID</option>
																</select>
															</div>
														</div>
														...
														<div class="form-group col-md-2">
															...
															<div class="col-sm-12">
																<select class="form-control select2" id="purpose" name="incoming_purpose" required>
																	<option>Choose Purpose</option>
																</select>
															</div>
														</div>

														<div class="form-group col-md-1" id="no_of_items_div">
															<label class="col-sm-12 col-form-label fw-bold" style="width: 90px;">No of items <span class="text-danger">*</span></label>
															<div class="col-sm-12">
																<input type="number" class="form-control" id="no_of_items" name="no_of_items" value="1" min="1" required/>
															</div>
														</div>

													</div>

													<div class="row base_second_row mt-3">
														<div class="form-group col-md-2">
															<label class="col-sm-12 col-form-label fw-bold">Mode of service <span class="text-danger">*</span></label>
															<div class="col-sm-12">
																<select class="form-control select2" id="service_mode" name="service_mode" required>
														...
														<div class="form-group col-md-2">
															<label class="col-sm-12 col-form-label fw-bold" style="width:194px;">Courier Agent / Vehicle No <span class="text-danger">*</span></label>
															<div class="col-sm-12">
														...
														<div class="form-group col-md-2 ms-1">
															<label class="col-sm-10 col-form-label fw-bold">From Location <span class="text-danger">*</span></label>
															<div class="col-sm-12">
														...
														<!-- <div class="form-group col-md-2">
															<label class="col-sm-10 col-form-label fw-bold">To Location</label>
															<div class="col-sm-12">
														...
														<div class="form-group col-md-2">
															...
															<div class="col-sm-12">
																<select class="form-control select2" id="from_emp_name" name="from_emp_name" required id="from_emp_name">
																</select>
															</div>
														</div>

														<!-- <div class="form-group col-md-2">
															<label class="col-sm-10 col-form-label fw-bold">To Type</label>
															<div class="col-sm-12">
														...
														<div class="form-group col-md-2" id="to_emp_div">
															<label class="col-sm-10 col-form-label fw-bold">To Whom <span class="text-danger">*</span></label>
															<div class="col-sm-12" id="to_emp_select_div">
																<select class="form-control select2" name="to_emp_name" id="to_emp_name" required>
																</select>
															</div>

															<!-- <div class="col-sm-12 dis-none" id="to_emp_custom_div">
																<input type="text" class="form-control" value="" id="to_txt_box" placeholder="Enter vehicle details" />
															</div> -->
														</div>
													</div>
												</div>
												...
												<div class="card-body">
													...
													<div class="form-group col-md-12 d-flex">
														...
														<div class="col-sm-10 ms-4">
															<input type="text" class="form-control" id="from_street1" name="from_street1" required/>
														</div>
													</div>
													<div class="form-group col-md-12 d-flex mt-3">
														<label class="form-label fw-bold">Street 2</label>
														<div class="col-sm-10" style="margin-left: 34px !important;">
															<input type="text" class="form-control" id="from_street2" name="from_street2"/>
														</div>
													</div>
													<div class="row">
														<div class="form-group col-md-12 d-flex mt-3">
															<label class="form-label fw-bold">City <span class="text-danger">*</span></label>
															<div class="col-sm-10" style="margin-left: 50px !important;">
														...
														<div class="form-group col-md-12 d-flex mt-3">
															...
															<div class="col-sm-10" style="margin-left: 42px !important;">
																<input type="text" class="form-control" id="from_state" name="from_state" required/>
															</div>
														</div>
													</div>
													<div class="form-group col-md-12 d-flex mt-3">
													...
													<div class="form-group col-md-12 d-flex mt-3">
														...
														<div class="col-sm-10 ms-4">
															<input type="text" class="form-control" id="from_pincode" name="from_pincode" required maxlength="6" onkeypress="return /[0-9]/i.test(event.key)" onpaste="return false;"/>
														</div>
													</div>
													<div class="form-group col-md-12 d-flex mt-3">
														<label class="form-label fw-bold">Phone No <span class="text-danger">*</span></label>
														<div class="col-sm-10" style="margin-left: 13px !important;">
															<input type="text" class="form-control" id="from_phone" name="from_phone" required maxlength="10" onkeypress="return /[0-9]/i.test(event.key)" onpaste="return false;"/>
														</div>
													</div>
											...
											<div class="card">
												<div class="card-body">
													...
													<div class="form-group col-md-12 d-flex mb-3 d-none" id="to_com_locations_div">
														<label class="form-label fw-bold">Company Locations</label>
														<div class="col-sm-12" style="margin-left: 10px;">
													...
													<div class="form-group col-md-12 d-flex">
														<label class="form-label fw-bold">Street 1</label>
														<div class="col-sm-10 ms-4">
															<input type="text" class="form-control" id="to_street1" required name="to_street1" />
														</div>
													</div>
													<div class="form-group col-md-12 d-flex mt-3">
														<label class="form-label fw-bold">Street 2</label>
														<div class="col-sm-10 ms-4">
															<input type="text" class="form-control" id="to_street2" required name="to_street2" />
														</div>
													</div>
													<div class="row">
														<div class="form-group col-md-12 d-flex mt-3">
															...
															<div class="col-sm-10" style="margin-left: 50px !important;">
																<input type="text" class="form-control" id="to_city" required name="to_city" />
															</div>
														</div>
														<div class="form-group col-md-12 d-flex mt-3">
															<label class="form-label fw-bold">State</label>
															<div class="col-sm-10" style="margin-left: 42px !important;">
																<input type="text" class="form-control" id="to_state" required name="to_state" />
															</div>
														</div>
													</div>
													<div class="form-group col-md-12 d-flex mt-3">
														...
														<div class="col-sm-10 ms-4">
															<input type="text" class="form-control" id="to_country" required name="to_country" />
														</div>
													</div>
													<div class="form-group col-md-12 d-flex mt-3">
														<label class="form-label fw-bold">Pincode</label>
														<div class="col-sm-10 ms-4">
															<input type="text" class="form-control" required id="to_pincode" name="to_pincode" onkeypress="return /[0-9]/i.test(event.key)"/>
														</div>
													</div>
													<div class="form-group col-md-12 d-flex mt-3">
														<label class="form-label fw-bold">Phone No</label>
														<div class="col-sm-10" style="margin-left: 13px !important;">
															<input type="text" class="form-control" required id="to_phone" name="to_phone" onkeypress="return /[0-9]/i.test(event.key)"/>
														</div>
													</div>
	...
	<script>
		...
		$(document).ready(function() {
			...
			get_emp_master();
			get_incoming_parcel_no();
			get_outgoing_parcel_all_no();
		});
		...
		function get_courier_category() 
		{
			$.ajax({
				...
				success: function(result) {
					var option = '<option>Choose Purpose</option>';
					if(result.length > 0) {
						for(i in result) {
		...
		function get_emp_master() 
		{
			$.ajax({
				...
				dataType:"json",
				success: function(result) {
					var option = '<option>Choose Employee</option>';
					if(result.length > 0) {
						for(i in result) {
		...
		function get_incoming_parcel_no()
		{
			$.ajax({
				type: "GET",
				url: "ajax/common_ajax.php",
				data: {
					"Action": "get_incoming_parcel_no",
				},
				dataType:"json",
				success: function(result) {
					...
					$('#ip_id').val('CIP-'+final_cop_no);
				}
			});
		}


		function get_outgoing_parcel_all_no()
		{
			$.ajax({
				type: "GET",
				url: "ajax/common_ajax.php",
				data: {
					"Action": "get_all_op_no",
				},
				dataType:"json",
				success: function(result) {
					var option = '<option value="">Choose OP ID</option>';
					if(result.length > 0) {
						for(i in result) {
							option += `<option value="${ result[i].op_no }">${ result[i].op_no }</option>`; 
						}
					}
					$('#op_id').select2('destroy');
					$('#op_id').html(option);
					$('#op_id').select2();
				}
			});
		...
		$(document).on('change','#op_id',function(){
			...
			if(op_no != '') {
				$.ajax({
					...
					url: "ajax/common_ajax.php",
					data: {
						"Action": "get_op_detail",
						"op_no" : op_no
					},
					dataType:"json",
					success: function(result) {
						$('#item_type').select2('destroy');
						$('#item_type').val(result[0].item_type).select2();
						$('#purpose').select2('destroy');
						$('#purpose').val(result[0].outgoing_purpose).select2();
						$('#no_of_items').val(result[0].no_of_items);
						$('#service_mode').select2('destroy');
						$('#service_mode').val(result[0].service_mode).select2();
						$('#courier_agent_det').val(result[0].service_type_agent);
						$('#vehicle_det').val(result[0].service_type_vehicle);
						$('#courier_service_type').val(result[0].service_type).select2().trigger('change');
						$('#from_location').val(result[0].from_location_type).select2().trigger('change');
					// $('#to_location').val(result[0].to_location_type).select2().trigger('change');

						$('#from_emp_name').select2('destroy');
						$('#from_emp_name').val(result[0].from_employee).select2();

					// $('#to_type').val(result[0].to_type).select2().trigger('change');

					// if(result[0].to_type == 'customer') {
					// 	$('#to_txt_box').val(result[0].to_customer_name);
					// } else if(to_type == 'vendor') {
					// 	$('#to_txt_box').val(result[0].to_vendor_name);
					// } else if(to_type == 'govt') {
					// 	$('#to_txt_box').val(result[0].to_govt_details);
					// } else if(to_type == 'others') {
					// 	$('#to_txt_box').val(result[0].to_other_details);
					// }

						$('#to_emp_name').select2('destroy');
						$('#to_emp_name').val(result[0].to_employee_code).select2();


						$('#from_com_loc').select2('destroy');
						$('#from_com_loc').val(result[0].from_company_plant_id).select2();

					// $('#to_com_loc').select2('destroy');
					// $('#to_com_loc').val(result[0].to_company_plant_id).select2();

						$('#from_street1').val(result[0].to_street1);
						$('#from_street2').val(result[0].to_street2);
						$('#from_city').val(result[0].to_city);
						$('#from_state').val(result[0].to_state);
						$('#from_country').val(result[0].to_country);
						$('#from_pincode').val(result[0].to_pincode);
						$('#from_phone').val(result[0].to_phone_no);

					// $('#to_street1').val(result[0].to_street1);
					// $('#to_street2').val(result[0].to_street2);
					// $('#to_city').val(result[0].to_city);
					// $('#to_state').val(result[0].to_state);
					// $('#to_country').val(result[0].to_country);
					// $('#to_pincode').val(result[0].to_pincode);
					// $('#to_phone').val(result[0].to_phone_no);
		...
		$(document).on('change','#incoming_type',function(){
			var value = $(this).val();
			var div = `<div class="form-group col-md-1" id="no_of_items_div">
			<label class="col-sm-12 col-form-label" style="width: 90px;">No of items</label>
			<div class="col-sm-12">
			<input type="number" class="form-control" name="no_of_items" value="1" min="1" required/>
			</div>
			</div>`;
			if(value == 'returnable') {
				$('#no_of_items_div').remove();
				$("#op_id_div").show();
				$('.base_second_row').prepend(div);
				$('#op_id').select2('destroy');
				$('#op_id').val('').select2();
			} else {
				$('#no_of_items_div').remove();
				$("#op_id_div").hide();
				$('.base_first_row').append(div);
				form_fields_reset();
			}
		});
		...
		function form_fields_reset()
		{
			...
			$('#no_of_items').val(1);
			$('#service_mode').select2('destroy');
			$('#service_mode').val('').select2();
			$('#courier_agent_det').val('');
			$('#vehicle_det').val('');
			$('#courier_service_type').val('').select2().trigger('change');
			$('#from_location').val('').select2().trigger('change');
			// $('#to_location').val('').select2().trigger('change');

			$('#from_emp_name').select2('destroy');
			$('#from_emp_name').val('').select2();

			// $('#to_type').val('').select2().trigger('change');

			// $('#to_txt_box').val('');

			$('#to_emp_name').select2('destroy');
			$('#to_emp_name').val('').select2();


			$('#from_com_loc').select2('destroy');
			$('#from_com_loc').val('').select2();

			// $('#to_com_loc').select2('destroy');
			// $('#to_com_loc').val('').select2();
		...
		$(document).on('submit','#income_form',function(e){
			e.preventDefault();
					...
					success: function(result) {
						...
						if(result.status == 200) {
							swal({
								...
								if(isconfirm) {
									 window.location = "Incoming_parcels_list.php";
								}
							});
						} else {
